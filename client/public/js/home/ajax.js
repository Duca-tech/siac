...
//             .then(response => {
//                 if (response.ok) {
//                     return response.json(); // Retorna o conteúdo do corpo da resposta como texto
//                 } else {
...
//             .then(data => {
//                 if (data === 'success') {
//                     window.location.href = '/user/login'; // Substitua 'outraPagina' pelo URL da sua outra página
//                 } else {
