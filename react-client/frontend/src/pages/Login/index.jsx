                ...
                <div className="row">
                    <div className="col-sm-5 text-black">
                        ...
                        <div className="px-4 ms-xl-4">
                            ...
                            <p className="h5 fw-light mt-2" style={{ fontSize: '1.1em' }}>Sistema Integrado de Atendimento às Clínicas</p>
                        </div>
                        ...
                        <div className="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                            <form style={{ width: '23rem' }}>
                                ...
                                <p className="small mb-4 pb-lg-2"><a className="text-muted" href="#!">Esqueceu a senha?</a></p>
